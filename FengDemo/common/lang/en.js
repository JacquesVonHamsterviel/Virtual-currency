export default {
  login: {
    ...
    login: "Login",
    noaccount: "No evoex account yet?",
    register: "Sign Up",
    ...
    r_mobile: "Mobile",
    r_email: "Mailbox",
    r_hasaccount: "Existing evoex account",
    r_next: "Next step",
  ...
  feed:{
   ...
   chongzhi:{
      ...
      type:'Type',
   	  amount:'Enter amount',
   	  upload:'Upload Token',
	  p_number:"Amount cannot be empty",
	  p_img:"Screenshot cannot be empty",
	  tishi:"hint",
	  del:"Are you sure you want to delete this image?",
   },
	my:{
		charge:"Top up",
		withdraw:"Withdraw",
